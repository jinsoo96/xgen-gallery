...
export const metadata = {
    title: "Insight Blog",
    description:
        "Plateer Labs Insight Blog — Case Study, Labs Tech, 제품 소식 등 Enterprise AI 연구·실무 인사이트를 공유합니다.",
    alternates: { canonical: "/blog" },
    openGraph: {
        title: "Insight Blog · Plateer Labs",
        description:
            "Case Study · Labs Tech · 제품 소식 — Enterprise AI 인사이트.",
        type: "website",
