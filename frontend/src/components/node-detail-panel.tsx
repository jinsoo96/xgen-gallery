                    ...
                    {context && !loading && (
                        <>
                            <div>
                                ...
                                <div className="mt-1.5 flex flex-wrap items-center gap-1.5 font-mono text-[10px] text-[var(--color-ink-subtle)]">
                                    {context.center.kind && (
                            ...
                            {(() => {
                                ...
                                return (
                                    <div className="mt-3 max-h-52 overflow-auto rounded-md border border-[var(--color-line)] bg-[var(--color-surface-alt)] p-3 text-[11.5px] leading-relaxed text-[var(--color-ink-muted)] whitespace-pre-wrap">
                                        {content}
                                    </div>
                                );
                            })()}
                            ...
                            <button
                                ...
                                className={cn(
                                    "mt-4 inline-flex w-full items-center justify-center gap-1.5 rounded-md border border-[var(--color-line)] bg-white px-3 py-2 text-[11px] font-medium transition",
                                    reinforcing
