...
<figure class="blog-illust">
<svg viewBox="0 0 1000 320" width="1000" height="320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="판정기가 조용히 죽어도 시스템은 기준만 느슨해진 채 계속 도는 fail-open 문제">
  <defs><linearGradient id="bg4b" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f6f9ff"/><stop offset="1" stop-color="#e9f1ff"/></linearGradient><marker id="m4a" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#94a3b8"/></marker></defs>
  <style>text{font-family:'Pretendard Variable',Pretendard,'Malgun Gothic','Apple SD Gothic Neo',system-ui,sans-serif}</style>
  <rect width="1000" height="320" fill="url(#bg4b)"/>
  <text x="44" y="48" font-size="25" font-weight="800" fill="#0f172a">판정기가 죽어도 시스템은 멈추지 않아요</text>
  <rect x="60" y="104" width="200" height="60" rx="12" fill="#ffffff" stroke="#d7e0f0"/><text x="160" y="141" text-anchor="middle" font-size="16" font-weight="700" fill="#334155">생성 답변</text>
  <line x1="264" y1="134" x2="300" y2="134" stroke="#94a3b8" stroke-width="3" marker-end="url(#m4a)"/><text x="282" y="122" text-anchor="middle" font-size="12" fill="#94a3b8">fail</text>
  <rect x="304" y="104" width="244" height="60" rx="12" fill="#fdecef" stroke="#f6c6d0"/><text x="426" y="133" text-anchor="middle" font-size="16" font-weight="700" fill="#b4315a">Judge 폴백 (죽음)</text><text x="426" y="152" text-anchor="middle" font-size="11" fill="#b4315a">로드 실패 · 기준 고정</text>
  <line x1="552" y1="134" x2="588" y2="134" stroke="#94a3b8" stroke-width="3" marker-end="url(#m4a)"/><text x="570" y="122" text-anchor="middle" font-size="12" fill="#94a3b8">pass</text>
  <rect x="592" y="104" width="296" height="60" rx="12" fill="#f8fafc" stroke="#e2e8f0"/><text x="740" y="141" text-anchor="middle" font-size="16" font-weight="700" fill="#64748b">무검증 통과</text>
  <text x="60" y="214" font-size="15" fill="#475569">실패가 정지가 아니라 '기준 완화'로 흘러요 — 겉으론 정상, 실제론 무너짐</text>
  <rect x="60" y="240" width="828" height="46" rx="12" fill="#ecf8f1" stroke="#bfe6cf"/><text x="474" y="269" text-anchor="middle" font-size="15" font-weight="700" fill="#1f9d57">해법 — Judge 활성 상태 계측 + 실제 LLM 종단 검증</text>
</svg>
</figure>
...
<figure class="blog-illust">
<svg viewBox="0 0 1000 340" width="1000" height="340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="노드 통합에서 얻은 두 규칙 — 실행 경로 단일화와 데이터 내용 기반 성공 판정">
  <defs><linearGradient id="bg4c" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f6f9ff"/><stop offset="1" stop-color="#e9f1ff"/></linearGradient><marker id="m4c" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#2563eb"/></marker></defs>
  <style>text{font-family:'Pretendard Variable',Pretendard,'Malgun Gothic','Apple SD Gothic Neo',system-ui,sans-serif}</style>
  <rect width="1000" height="340" fill="url(#bg4c)"/>
  <text x="44" y="50" font-size="26" font-weight="800" fill="#0f172a">노드로 접으며 세운 규칙 둘</text>
  <rect x="44" y="82" width="430" height="210" rx="16" fill="#ffffff" stroke="#d7e0f0"/>
  <text x="68" y="118" font-size="17" font-weight="800" fill="#2563eb">① 실행 경로는 하나로</text>
  <rect x="68" y="134" width="150" height="36" rx="8" fill="#f1f5f9" stroke="#e2e8f0"/><text x="143" y="157" text-anchor="middle" font-size="14" fill="#334155">캔버스 실행</text>
  <rect x="68" y="182" width="150" height="36" rx="8" fill="#f1f5f9" stroke="#e2e8f0"/><text x="143" y="205" text-anchor="middle" font-size="14" fill="#334155">저장 워크플로우</text>
  <line x1="222" y1="152" x2="296" y2="169" stroke="#2563eb" stroke-width="3" marker-end="url(#m4c)"/>
  <line x1="222" y1="200" x2="296" y2="181" stroke="#2563eb" stroke-width="3" marker-end="url(#m4c)"/>
  <rect x="300" y="155" width="150" height="40" rx="10" fill="#2563eb"/><text x="375" y="181" text-anchor="middle" font-size="15" font-weight="700" fill="#ffffff">공통 모듈</text>
  <text x="68" y="264" font-size="14" fill="#64748b">버그를 두 번 고칠 필요가 없어져요</text>
  <rect x="526" y="82" width="430" height="210" rx="16" fill="#ffffff" stroke="#d7e0f0"/>
  <text x="550" y="118" font-size="17" font-weight="800" fill="#2563eb">② 성공은 데이터 내용으로</text>
  <rect x="550" y="136" width="382" height="40" rx="10" fill="#fdf1f4" stroke="#f6c6d0"/><text x="566" y="161" font-size="14" fill="#b4315a">✗ HTTP 200 · 응답 길이 = 도착만 확인</text>
  <rect x="550" y="188" width="382" height="58" rx="10" fill="#ecf8f1" stroke="#bfe6cf"/><text x="566" y="212" font-size="14" fill="#1f9d57">✓ 정해진 형식 · 기억 회상 ·</text><text x="566" y="232" font-size="14" fill="#1f9d57">    실제 데이터가 기대와 일치</text>
  <text x="550" y="274" font-size="14" fill="#64748b">응답이 왔는지가 아니라 '무엇을 응답했는가'</text>
</svg>
</figure>
